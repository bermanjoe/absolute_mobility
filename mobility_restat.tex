...
Another common measure of relative mobility is the rank-rank slope (RRS), defined as the slope of the straight line found by ``regressing the child's rank on his parents' rank'' in their marginal income distributions~\citep[p.~1561]{chetty2014land}. We denote it by $\rho$. As a rank-based measure, RRS depends only on the copula of the joint income distribution of parents and children, whereas IGE depends additionally on the standard deviation of the log-incomes. \citet[p.~1561]{chetty2014land} argued that rank-rank slopes ``prove to be much more robust across specifications and are thus more suitable for comparisons across areas from a statistical perspective''. Similarly to IGE, the RRS is also a measure of immobility, and we use $R_2 \equiv 1-\rho$ as the corresponding measure of relative mobility.
